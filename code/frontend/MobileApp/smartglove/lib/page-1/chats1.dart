                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      padding: EdgeInsets.fromLTRB(15*fem, 16*fem, 15*fem, 0*fem),
                      width: double.infinity,
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.center,
                        children: [
                            ...
                            child: Stack(
                              children: [
                                Positioned(
                                  ...
                                  top: 26*fem,
                                  child: Container(
                                    padding: EdgeInsets.fromLTRB(1.6*fem, 0*fem, 0*fem, 0*fem),
                                    width: 107*fem,
                                    height: 18*fem,
                                    child: Row(
                                      crossAxisAlignment: CrossAxisAlignment.center,
                                      children: [
                                        Opacity(
                                          ...
                                          opacity: 0.6,
                                          child: Container(
                                            margin: EdgeInsets.fromLTRB(0*fem, 0.48*fem, 5.5*fem, 0*fem),
                                            width: 12.91*fem,
                                            height: 6.69*fem,
                                            child: Image.asset(
                                  ...
                                  child: Container(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Container(
                                          // harrydeviTk (84:133)
                                          margin: EdgeInsets.fromLTRB(0*fem, 4*fem, 137*fem, 0*fem),
                                          child: Text(
                                            'Harry Dev',
                                            style: SafeGoogleFont (
                                              'Inter',
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        margin: EdgeInsets.fromLTRB(0*fem, 4*fem, 28*fem, 4*fem),
                                        height: double.infinity,
                                        child: Column(
                                          crossAxisAlignment: CrossAxisAlignment.start,
                                          children: [
