                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      margin: EdgeInsets.fromLTRB(16*fem, 0*fem, 29*fem, 0*fem),
                      width: double.infinity,
                      height: 274*fem,
                      child: Stack(
                        children: [
                              ...
                              child: Column(
                                ...
                                children: [
                                  Container(
                                    ...
                                    margin: EdgeInsets.fromLTRB(1*fem, 0*fem, 0*fem, 51*fem),
                                    child: Text(
                                      'Enter Model Number ',
                                      style: SafeGoogleFont (
                                        'Inter',
                                  ...
                                  Container(
                                    // frame6CZp (99:293)
                                    margin: EdgeInsets.fromLTRB(98*fem, 0*fem, 80*fem, 0*fem),
                                    child: TextButton(
                                      onPressed: () {},
